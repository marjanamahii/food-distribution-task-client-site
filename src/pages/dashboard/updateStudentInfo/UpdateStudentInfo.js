...
const UpdateStudentInfo = () => {
    ...
    useEffect(() => {
        axios.get(`https://floating-plains-90114.herokuapp.com/single-student?studentId=${studentId}`)
            .then((response) => {
    ...
    const handleForm = e => {
        ...
        axios.patch(`https://floating-plains-90114.herokuapp.com/update-student-info?studentId=${studentId}`, studentData)
            .then((response) => {
